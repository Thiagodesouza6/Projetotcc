...
<body>
    ...
    <p>
        A<strong> Mirror Fashion</strong> é a maior empresa comercio eletronica no segmento de moda em todo mundo.
    ...
    <figure id="centro-distribuicao">
        ...
        alt="Foto do centro de distribuição de Mirror Fashion">
    ...
    <ul>
        ...
        <li> Se você achar uma Loja mais barata devolvemos a diferença </li>
        <li> Frete Grátis </li>
